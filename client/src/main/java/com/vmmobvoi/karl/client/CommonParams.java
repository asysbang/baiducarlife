...
public class CommonParams {
    ...
    public static final int PROTOCOL_VERSION_MAJOR_VERSION = 9;
    public static final int PROTOCOL_VERSION_MINOR_VERSION = 1;
    ...
    public static final int MSG_MAIN_DISPLAY_HELP_MAIN_FRAGMENT = 2010;
    ...
    public static boolean PULL_UP_VEHICLE = false;
